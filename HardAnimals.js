document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        const animals = data.animals.hard;
        
        let sanskritNames = [...animals.sanskrit_names];
        let images = [...animals.images];
        let pairs = { ...animals.pairs };
        ...
        images.forEach(imgSrc => {
            ...
            imgElement.classList.add("animals-image");
